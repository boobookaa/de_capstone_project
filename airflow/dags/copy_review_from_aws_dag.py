...
def copy_review_data(*args, **kwargs):
    """
    Copy reviews from a particular Product_Category from Amazon Customer Reviews Dataset to Landing Layer for further processing
    :param args:
    :param kwargs:
    :return:
    """
...
dag = DAG('copy_review_from_aws_S3',
    default_args    = default_args,
    description     = "Copy Reviews from S3 to the Landing Layer",
